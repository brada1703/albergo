            ...
            <div class="dropdown" style="display: inline-block;">
              <a href="#" class="dropdown-toggle" id="languageMenuTop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                ...
                <ul class="dropdown-menu" aria-labelledby="languageMenuTop">
                  <li><a style="cursor: pointer;" role="menuitem" tabindex="-1" ng-click="changeLanguage('en')">English</a></li>
                  <li><a style="cursor: pointer;" role="menuitem" tabindex="-1" ng-click="changeLanguage('it')">Italiano</a></li>
            </div> |
